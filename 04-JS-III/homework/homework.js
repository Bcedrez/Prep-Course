...
function cuentoElementos(arreglo = []){
  ...
  //Escribe tu código aquí
  const mayoresA18 = arreglo.filter(element => element > 18)
...
function diaDeLaSemana(numeroDeDia) {
  ...
  if(diasDeLaSemana[numeroDeDia]==="Sábado" || diasDeLaSemana[numeroDeDia]==="Domingo"){
...
function mesesDelAño(array) {
  ...
  // Tu código:
  const nuevoArray = array.filter(mes =>{      
...
function mayorACien(array) {
  ...
  // Tu código:
  const nuevoArray = array.filter(elemento => elemento > 100)
  return nuevoArray
}
